...
**Generated:** 2026-04-02T07:34:45.634728
...
| 3 | image_generation | 442 | 1 | 194 | 1.57 | +0.0 | 11335 |
...
| 8 | notification_service | 567 | 2 | 176 | 2.30 | +0.0 | 11357 |
| 9 | data_visualization | 625 | 2 | 171 | 2.46 | +0.0 | 11357 |
| 10 | deployment_pipeline | 650 | 2 | 165 | 2.59 | +0.0 | 11357 |
...
| Total windows | 15 |
| Total entries | 1,779 |
| Total append time | 19.7s |
| Avg time per skill | 1.97s |
| Avg tokens/second | 254 |
...
|---|-----------|-------|----------|-----|---------|------------|
| 1 | easy | What's the temperature in Tokyo right now? | weather_api | weather_api | yes | 6542 |
| 2 | easy | Show me all users who signed up last week from the... | sql_query | sql_query | yes | 6897 |
| 3 | easy | Generate a watercolor painting of a mountain lands... | image_generation | image_generation | yes | 6808 |
| 4 | easy | Schedule a meeting with the design team next Thurs... | calendar | calendar | yes | 6506 |
| 5 | easy | Convert this DOCX report to PDF with A4 page size | file_converter | file_converter | yes | 6800 |
| 6 | easy | Create a new git branch called feature/payments an... | git_operations | git_operations | yes | 6762 |
| 7 | medium | Send an email to the client with the monthly repor... | email_sender | email_sender | yes | 7042 |
| 8 | medium | Create a bar chart showing revenue by month from t... | data_visualization | data_visualization | yes | 6883 |
| 9 | hard | Send a notification to the team that the deploy su... | notification_service | notification_service | yes | 6799 |
| 10 | hard | After deploying to staging, email the QA team and ... | deployment_pipeline | notification_service | yes | 6860 |

### Query Timing Breakdown

| # | Expansion (ms) | Route (ms) | Prefill (ms) | Generate (ms) | Total (ms) |
|---|---------------|------------|-------------|--------------|------------|
| 1 | 1152 | 3 | 1584 | 3794 | 6542 |
| 2 | 1156 | 0 | 1891 | 3844 | 6897 |
| 3 | 1130 | 0 | 1940 | 3733 | 6808 |
| 4 | 1125 | 0 | 1650 | 3727 | 6506 |
| 5 | 1122 | 0 | 1848 | 3824 | 6800 |
| 6 | 1149 | 0 | 1831 | 3776 | 6762 |
| 7 | 1129 | 0 | 1870 | 4038 | 7042 |
| 8 | 1129 | 0 | 1981 | 3767 | 6883 |
| 9 | 1140 | 0 | 1900 | 3752 | 6799 |
| 10 | 1131 | 0 | 1921 | 3802 | 6860 |

**Average query time:** 6790ms (routing: 0ms)
